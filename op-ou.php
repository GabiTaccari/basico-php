			...
			<article class="conteudo">
				...
				<div class="inner">
					...
					<center>
						...
						<tr><td><br></td></tr>
						<tr><td><label><b> Primeiro Semestre: </b></label></td></tr><br>
						<tr><td><label> Digite uma nota: </label> <input type = "text" name = "num1" required/><p/></tr></td><br>
						<tr><td><label> Digite outra nota: </label><input type="text" name="num2" required/><p/></tr></td>
						<tr><td><label><br><b> Segundo Semestre: </b></label></td></tr><br>
						<tr><td><label> Digite uma nota: </label> <input type = "text" name = "num3" required/><p/></tr></td><br>
						<tr><td><label> Digite outra nota: </label><input type="text" name="num4" required/><p/></tr></td>
						<tr><td><input type = "submit" name="btncalcular" value="Calcular"></center></tr></td>

					</center>
					</form>
					<br><br>
					Código php utilizado:<br><br>
					&lt;?php<br>
							&nbsp;&nbsp;$n1 = $_POST['num1'];<br>
							&nbsp;&nbsp;$n2 = $_POST['num2'];<br>
							&nbsp;&nbsp;if($n1>=7 && $n2>=7)<br>
				...
				<div class="inner">
					...
					<center>
						...
						<?php
							...
							$n2 = $_POST['num2'];
							if($n1>=7 || $n2>=7){
								echo "<br><font color='#0000FF'>Aluno não está de recuperação</font>";
							}
							else
							{
								echo"<br><font color='#FF0000'>Aluno está de recuperação</font>";
							}
						?>
