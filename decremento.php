  <html>
	<head>
		<meta charset="utf-8">
		<title> Demais Operadores - DIÁRIO DE BORDO </title>
	...
	<body>
		<header class="cabecalho">
			...
			<div class="titulo">
				<h1>
					<center>
						DEMAIS OPERADORES - DIÁRIO DE BORDO
					</center>
				</h1>
			</div>
		</header>
		...
		<main class="conteudos">
			<article class="conteudo">
				...
				<div class="inner">
					...
					Exemplo: <br>
					Digite seu nome e sua idade para recuperá-los e entender como funciona a concatenação:
					<form name = "concatenacao" action="concatenacao.php" method="post">
					<center>
						
						<tr><td><br></tr></td>
						<tr><td><label> Digite seu nome: </label> <input type = "text" name = "nome" required/><p/></tr></td><br>
						<tr><td><label> Digite sua idade: </label> <input type = "text" name = "idade" required/><p/></tr></td><br>
						<tr><td><input type = "submit" name="btncalcular" value="Recuperar"></center></tr></td>
					</form>
					<br>
				...
				<div class="inner">
					...
					<center>
						...
						<?php
							...
							echo "O número final é: ". $n1. "<br><br>";
							echo "<a href='outros-operadores.html'><font color='#000000'> Voltar </a>";
					?></center>
