...
<article class="conteudo">
			...
			<article class="conteudo">
				...
				<div class="inner">
					<h2>Passo 1: </h4>
					<p align="justify">Para realizar a busca de dados no banco de dados, é necessário a criação de um arquivo .php que tenha acesso aos dados do banco de dados e exiba para o usuário. Seguindo o exemplo do nome e do email, temos: </p><br><br>

					 &lt;?php<Br>
 						include_once('conexao.php');<br>

 //executa a query com base na conexão<br>
 $query=mysqli_query($conexao, "select * from cadastro");<br>
 ...
 echo "&lt;tr&gt;&lt;th&gt; Matrícula &lt;/th&gt;&lt;th&gt; Nome &lt;/th&gt;&lt;th&gt;Email&lt;/th&gt;&lt;/tr&gt;";<br>
 ...
 ?&gt;
			...
			<article class="conteudo">
				<img src="img/insert1.jpg"/></a>
				<div class="inner">
					<h2>Exemplo Cadastro: </h4>

					 <?php
 include_once('conexao.php');
 
 //executa a query com base na conexão
 $query=mysqli_query($conexao, "select * from cadastro");
 ...
 echo"</table>";
 echo"<a href='pesquisa-geral.html'> Voltar </a>";
 echo "</center>";
