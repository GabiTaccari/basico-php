	...
	<body>
		...
		<main class="conteudos">
			<article class="conteudo">
				...
				<div class="inner">
					...
					<center>
						...
						<tr><td><br></tr></td>
						<tr><td><label> Digite seu ano de nascimento: </label> <input type = "text" name = "num1" required/><p/></tr></td><br>
			...
			<article class="conteudo">
				...
				<div class="inner">
					<h2> > e < : </h2>
					<p align="justify"> Os operadores maior e o de menor são utilizados para verificar se o valor armazenado é maior ou menos, respectivamente, do que outro valor ou outra variável, representado pelo sinal de maior (>) e o sinal de menor (<). Retornam TRUE caso a verificação for verdade e FALSE caso for falsa é dado pela seguinte sintaxe: <br><br></p>
					$variavel1 > $variavel2;<br><br>  $variavel1 < $variavel2;<br><br>
					Exemplo:<br>
					Digite sua idade para saber a categoria em que você se encaixa:
					...
					<center>
						...
						<tr><td><br></tr></td>
						<tr><td><label> Digite sua idade: </label> <input type = "text" name = "num1" required/><p/></tr></td><br>
						<tr><td><input type = "submit" name="btncalcular" value="Verificar"></center></tr></td>
				...
				<div class="inner">
					...
					<center>
						...
						<?php
							...
							if ($pont>=0 && $pont<=7)
							{
							echo "Pontuação ruim, precisa melhorar";
							}

							if($pont>7 && $pont <= 12)
							{
							echo"Pontuação regular";
							}
							if($pont>13 && $pont <= 18)
							{
								echo"Pontuação boa";
							...
							if ($pont>18)
							{
								echo"Pontuação muito boa/excelente";
							}
